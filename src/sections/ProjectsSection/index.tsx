...
const projects = [
    {
        ...
        links: [
            ...
            {href: 'https://halime.tr/honeybee-cakes/', text: 'Demo', icon: 'link-icon'},
        ],
    },
    {
        ...
        links: [
            ...
            {href: 'https://halime.tr/munamii-cakery/', text: 'Demo', icon: 'link-icon'},
        ],
    },
    {
        title: 'Maze Maker',
        ...
        stack: ['HTML', 'P5.js'],
        links: [
            {href: 'https://github.com/halimeucarturk/portfolio', text: 'GitHub', icon: 'github-icon-2'},
    ...
    {
        title: 'Tic Tac Toe',
        description: 'Tic Tac Toe is a classic two-player game implemented as a web application. The project focuses on game logic, turn-based interaction, and real-time updates, providing a simple and intuitive user experience.',
        stack: ['JavaScript', 'HTML', 'CSS'],
        links: [
            {href: 'https://github.com/halimeucarturk/portfolio', text: 'GitHub', icon: 'github-icon-2'},
            {href: 'https://mini.halime.tr/tic-tac-toe/', text: 'Demo', icon: 'link-icon'},
        ],
    },
    {
        title: 'CV',
        ...
        links: [
            ...
            {href: 'https://halime.tr/cv/', text: 'Demo', icon: 'link-icon'},
        ],
    },
];
